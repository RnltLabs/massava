...
This document describes the error handling system for the notification feature, following the Result<T, E> pattern described in the project's CLAUDE.md.
...
- [Project Standards](/CLAUDE.md) - Error handling standards
