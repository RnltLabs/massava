...
exports.getRouteWithBasePath = getRouteWithBasePath;
 ...
 */
function getRouteWithBasePath(path) {
 ...
 */
function getRedirectUrl(path, baseUrl) {
 ...
 */
function getAuthCallbackUrl(path) {
