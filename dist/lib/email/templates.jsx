...
exports.getPlainTextVerification = getPlainTextVerification;
exports.getPlainTextWelcome = getPlainTextWelcome;
exports.getPlainTextPasswordReset = getPlainTextPasswordReset;
...
function EmailVerificationTemplate({ verificationUrl, locale = 'de', }) {
    const content = {
        de: {
    ...
    return (<div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <p style={{ ...styles.text, wordBreak: 'break-all', fontSize: '12px' }}>
...
function WelcomeEmailTemplate({ name, locale = 'de', }) {
    const content = {
        de: {
...
function PasswordResetTemplate({ resetUrl, locale = 'de', }) {
    const content = {
        de: {
...
function getPlainTextVerification(verificationUrl, locale = 'de') {
    const content = {
        de: `
...
function getPlainTextWelcome(name, locale = 'de') {
    const appUrl = process.env.NEXTAUTH_URL || 'http://localhost:3000';
    // Since migration to massava.app, no basePath is used
    const basePath = '';
    const studiosUrl = `${appUrl}${basePath}/studios`;
...
function getPlainTextPasswordReset(resetUrl, locale = 'de') {
    const content = {
        de: `
